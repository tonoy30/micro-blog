...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      profile.github_user_name = !isEmpty(profile.github_user_name)
      ...
      profile.instagram = !isEmpty(profile.social.instagram)
        ...
        : "";
      profile.reddit = !isEmpty(profile.social.reddit)
  ...
  onSubmit = e => {
    ...
    const profileData = {
      ...
      github_user_name: this.state.github_user_name,
      bio: this.state.bio,
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <SelectListGroup
                  ...
                  error={errors.status}
                  options={options}
                  info="Give us a idea of where are you in your career"
                />
                <TextFieldGroup
                  placeholder="Company"
                  name="company"
                ...
                <TextFieldGroup
                  ...
                  value={this.state.github_user_name}
                  onChange={this.onChange}
                  error={errors.github_user_name}
                  info="If you want your latest repos and a Github link, include username."
                />
                <TextAreaFieldGroup
                ...
                <div className="mb-3">
                  ...
                  <span className="tex-muted ml-3">Optional</span>
                </div>
                {socialInputs}
                <input
                  type="submit"
